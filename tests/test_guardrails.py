    ...
    corr_df = pd.DataFrame(
        {
            ...
            "share_deregulated_ren": [0.50, 0.35],
    ...
    corr_df = pd.DataFrame(
        {
            ...
            "share_deregulated_ren": [0.35, 0.35],
    ...
    corr_df = pd.DataFrame(
        {
            ...
            "share_deregulated_ren": [0.0098, 0.0061],
    ...
    corr_df = pd.DataFrame(
        {
            ...
            "share_deregulated_ren": [0.0003, 0.0010],
    ...
    corr_df = pd.DataFrame(
        {
            ...
            "share_deregulated_ren": [0.40, 0.35, 0.30],
    ...
    df = pd.DataFrame(
        {
            ...
            "xrate": [2.68, 2.8],
            "share_deregulated_ren": [0.0213, 0.0642],
...
def test_answer_clarify_offers_residual_bucket_options_for_underdefined_numeric_target():
    ...
    assert "residual after excluding regulated hydro, regulated thermals, and deregulated renewable" in out.summary
