...
_BALANCING_ENTITY_ALIAS_MAP: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("imports", ("import",)),
    ("import", ("import",)),
    ("deregulated renewable generation", ("deregulated_ren",)),
    ("deregulated renewables", ("deregulated_ren",)),
    ("deregulated renewable", ("deregulated_ren",)),
    ("deregulated_ren", ("deregulated_ren",)),
