...
# Versioned wire contract between the edge gateway and the backend /ask endpoint
# (P6.A). The published JSON Schema artifact (contracts/chat_gateway_v1.schema.json,
# generated by scripts/export_chat_gateway_contract.py) is pinned to this string;
