...
def llm_plan_report_research(
    ...
    *,
    ...
    system = (
        ...
        "question about a shifting composition is share_delta_mom. Leave it "
        "empty when the questions ask only for levels, and never request a "
        "comparison the questions do not ask for -- an unmet derived metric "
        "costs the track its evidence. "
