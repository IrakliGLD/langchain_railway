...
ENABLE_SKILL_PROMPTS_SUMMARIZER = os.getenv("ENABLE_SKILL_PROMPTS_SUMMARIZER", "false").lower() in ("1", "true", "yes", "on")
ENABLE_SKILL_PROMPTS_PLANNER = os.getenv("ENABLE_SKILL_PROMPTS_PLANNER", "false").lower() in ("1", "true", "yes", "on")
