...
VECTOR_KNOWLEDGE_MAX_CHARS_EXPLANATION = max(
    500, int(os.getenv("VECTOR_KNOWLEDGE_MAX_CHARS_EXPLANATION", "18000"))
)
VECTOR_KNOWLEDGE_MAX_CHARS_KNOWLEDGE = max(
    500, int(os.getenv("VECTOR_KNOWLEDGE_MAX_CHARS_KNOWLEDGE", "24000"))
)
VECTOR_KNOWLEDGE_MAX_CHARS_REGULATORY = max(
    500, int(os.getenv("VECTOR_KNOWLEDGE_MAX_CHARS_REGULATORY", "30000"))
)
