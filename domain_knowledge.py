DOMAIN_KNOWLEDGE = {
    # =========================================================================
    # GENERAL DEFINITIONS - For conceptual/definitional questions
    # =========================================================================
    "GeneralDefinitions": {
        "description": "Basic energy sector terminology for answering general conceptual questions. Provides universal definitions with Georgia-specific context.",
        "terms": {
            "renewable_energy": {
                ...
                "georgia_context": "Georgia's electricity is predominantly renewable, with hydropower providing over 80% of domestic generation. Wind and solar capacity is growing under PPA and CfD support schemes. Key renewable sources: large HPPs (Enguri, Vardnili), small HPPs, and emerging wind/solar projects."
            },
            "electricity_market": {
                ...
                "georgia_context": "Georgia operates a hybrid market with: (1) Bilateral contracts between generators and suppliers, (2) Balancing market (since 2006) for residual supply/demand, (3) Day-ahead exchange (since July 2024). ESCO (Electricity System Commercial Operator) manages settlements."
            },
            "balancing_market": {
                ...
                "georgia_context": "Georgia's balancing market is the main price-setting mechanism. Balancing electricity price is a weighted average of all sources (regulated HPPs, deregulated hydro, thermal PPAs, renewable PPAs, imports). Summer prices are lower (hydro-dominated), winter prices higher (thermal/import-dominated)."
            },
            "tariff": {
                ...
                "georgia_context": "GNERC (Georgian National Energy and Water Supply Regulatory Commission) sets cost-plus tariffs for regulated generators including large HPPs (Enguri, Vardnili) and thermal plants (Gardabani TPP, old TPPs). Tariffs are denominated in GEL but adjusted for exchange rate changes."
            },
            "ppa": {
                "definition": "Power Purchase Agreement - a long-term contract between an electricity generator and a buyer (utility, government, or corporate) guaranteeing purchase of electricity at agreed prices for a set period (typically 10-25 years).",
                "georgia_context": "Georgia uses PPAs as a support scheme for new generation capacity. Renewable PPAs cover hydro, wind, and solar projects. Thermal PPAs exist for gas-fired plants. PPA prices are typically USD-indexed. PPAs provide revenue certainty for investors but create long-term price commitments."
            },
            "cfd": {
                "definition": "Contract for Difference - a financial instrument where a generator receives (or pays back) the difference between a guaranteed 'strike price' and the market price. If market price is below strike price, generator receives a top-up payment; if above, generator pays back the difference.",
                "georgia_context": "Georgia introduced CfD scheme in 2023 for new renewable projects through capacity auctions. First auction (2023) awarded ~170 MW to hydro, solar, and wind projects. CfD provides price stability for investors while allowing generators to participate in the market. CfD projects are centrally dispatched."
            },
            "hydropower": {
                ...
                "georgia_context": "Georgia has significant hydropower resources. Major plants: Enguri (1,300 MW, reservoir), Vardnili cascade, Zhinvali, Khrami. Hydro provides cheap electricity but output varies seasonally - high in spring/summer (snowmelt), low in winter. Most Georgian hydro is run-of-river with limited storage."
            },
            "thermal_power": {
                ...
                "georgia_context": "Georgia's thermal generation uses natural gas (imported from Azerbaijan). Key plants: Gardabani TPP (new, efficient), old TPPs (Tbilisi TPP, Mtkvari Energy, G-Power). Thermal plants are critical for winter when hydro output is low. Gas is priced in USD, so thermal costs correlate with exchange rate."
            },
            "import_export": {
                ...
                "georgia_context": "Georgia imports electricity primarily in winter (when domestic hydro is insufficient) and can export in summer (hydro surplus). Main interconnections: Turkey, Azerbaijan, Armenia, Russia. Import prices are USD-based and depend on regional market conditions."
            },
            "demand": {
                ...
                "georgia_context": "Georgia's electricity demand shows seasonal patterns: winter peaks (heating, lighting) and summer peaks (cooling in recent years). Total consumption is around 13-14 TWh annually. Large industrial consumers (direct customers) can purchase directly from generators."
            },
            "generation_mix": {
                ...
                "georgia_context": "Georgia's generation mix is hydro-dominated (~80% in good water years). Thermal fills winter gaps. Wind/solar are small but growing. No nuclear power. Import dependence increases in dry winters. The mix in balancing market differs from total generation (PPAs reduce balancing volumes)."
            },
            "capacity_vs_energy": {
                ...
                "georgia_context": "Georgia has ~4,500 MW installed capacity but actual generation depends on hydrology and dispatch. Capacity factor varies: hydro 30-50% (seasonal), thermal 20-40% (backup role), wind/solar 20-30% (weather-dependent)."
            },
            "regulated_vs_deregulated": {
                ...
                "georgia_context": "In Georgia: Regulated = Enguri HPP, Vardnili, old/new TPPs (GNERC tariffs). Deregulated = small hydro selling at market prices. PPAs are a hybrid (contracted prices, not pure market). The share of deregulated hydro in balancing market affects price levels."
            },
            "exchange_rate_impact": {
                ...
                "georgia_context": "Georgia's electricity prices are highly sensitive to GEL/USD exchange rate because: (1) natural gas for thermal plants is USD-priced, (2) imports are USD-priced, (3) PPA prices are often USD-indexed. GEL depreciation → higher electricity prices in GEL terms."
            }
        },
        "usage_instructions": [
