...
**Frontend/Supabase implementation status (2026-07-14):** The independently executable subset is complete in frontend commit `9bbe444`. It does not close P5.1 or authorize P5.A checkboxes: the browser and Edge Function currently enforce reviewed local budgets, while the backend still needs a versioned absolute deadline, remaining-time propagation, final retry ownership, and end-to-end cancellation/duplicate-charge evidence.
